...
class CustomTransition2(private val direction: Boolean = true) : Transition() {
...
//            view.translationY = translationY
    ...
    private fun getBounds(view: View): Rect {
        Log.e("!!!", "left = ${view.left}, top = ${view.top}, right = ${view.right}, bottom = ${view.bottom}")
    ...
    private fun getAbsoluteBounds(view: View): Rect {
        ...
        Log.e("!!!", "location0 = ${location[0]} location1 = ${location[1]} width = ${view.width} height = ${view.height}")
